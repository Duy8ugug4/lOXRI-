...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>timhack chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "timhack", HidePremium = false, IntroText = "timhack⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("timhack SCRIPT")
W:AddLabel("Discordtimhack")
local Section = W:AddSection({
    Name = "Status"
})
